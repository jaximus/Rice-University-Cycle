...
override PKGDIR = xconfig_i2ctmp006
...
package/%.xdc.inc package/%_xconfig_i2ctmp006.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package xconfig_i2ctmp006" (because $@ is older than $(firstword $?))" ...
...
i2ctmp006.xem4f: package/cfg/i2ctmp006_pem4f.oem4f 
	...
	@$(MSG) lnkem4f $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.arm.elf.M4F.rootDir)/bin/armlnk -w -q -u _c_int00 -fs $(XDCCFGDIR)$(dir $@).  -q -o $@ package/cfg/i2ctmp006_pem4f.oem4f   package/cfg/i2ctmp006_pem4f.xdl --silicon_version=7M4 --strict_compatibility=on -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.arm.elf.M4F.rootDir)/lib/libc.a
...
.PHONY: release,xconfig_i2ctmp006
ifeq (,$(MK_NOGENDEPS))
-include package/rel/xconfig_i2ctmp006.tar.dep
endif
package/rel/xconfig_i2ctmp006/xconfig_i2ctmp006/package/package.rel.xml: package/package.bld.xml
package/rel/xconfig_i2ctmp006/xconfig_i2ctmp006/package/package.rel.xml: package/build.cfg
package/rel/xconfig_i2ctmp006/xconfig_i2ctmp006/package/package.rel.xml: package/package.xdc.inc
package/rel/xconfig_i2ctmp006/xconfig_i2ctmp006/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

xconfig_i2ctmp006.tar: package/rel/xconfig_i2ctmp006.xdc.inc package/rel/xconfig_i2ctmp006/xconfig_i2ctmp006/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/xconfig_i2ctmp006.xdc.inc,package/rel/xconfig_i2ctmp006.tar.dep)


release release,xconfig_i2ctmp006: all xconfig_i2ctmp006.tar
clean:: .clean
	-$(RM) xconfig_i2ctmp006.tar
	-$(RM) package/rel/xconfig_i2ctmp006.xdc.inc
	-$(RM) package/rel/xconfig_i2ctmp006.tar.dep
